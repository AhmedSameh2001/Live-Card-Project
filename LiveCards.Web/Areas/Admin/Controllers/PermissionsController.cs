...
namespace LiveCards.Web.Areas.Admin.Controllers
{
    ...
    public class PermissionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,URL,Title,TitleEn,ParentId,ShowInMenu,OrderId,Icon,CurrentPage,Description,DescriptionEn")] Permission permission)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,URL,Title,TitleEn,ParentId,ShowInMenu,OrderId,Icon,CurrentPage,Description,DescriptionEn")] Permission permission)
        {
            if (id != permission.Id)
            {
                return NotFound();
