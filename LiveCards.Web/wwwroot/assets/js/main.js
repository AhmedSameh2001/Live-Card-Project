...
(function($) {
    ...
    /*----------------------------- Load More Category -------------------------------- */
    $(document).ready(function() {
        $(".ec-more-toggle-1").click(function() {
            var elem = $(".ec-more-toggle-1 #ec-more-toggle").text();
            if (elem == "More Categories") {
                $(".ec-more-toggle-1 #ec-more-toggle").text("Less Categories");
                $(".ec-more-toggle-1").toggleClass('active');
                $("#ec-more-toggle-content").slideDown();
            } else {

                $(".ec-more-toggle-1  #ec-more-toggle").text("More Categories");
                $(".ec-more-toggle-1").removeClass('active');
                $("#ec-more-toggle-content").slideUp();
            }
        });
    });
    $(document).ready(function () {
        $(".ec-more-toggle-2").click(function () {
            var elem = $(".ec-more-toggle-2 #ec-more-toggle-1").text();
            if (elem == "More Categories") {
                $(".ec-more-toggle-2 #ec-more-toggle-1").text("Less Categories");
                $(".ec-more-toggle-2").toggleClass('active');
                $("#ec-more-toggle-content-1").slideDown();
            } else {

                $(".ec-more-toggle-2  #ec-more-toggle-1").text("More Categories");
                $(".ec-more-toggle-2").removeClass('active');
                $("#ec-more-toggle-content-1").slideUp();
            }
        });
    });
    $(document).ready(function () {
        $(".ec-more-toggle-3").click(function () {
            var elem = $(".ec-more-toggle-3 #ec-more-toggle-2").text();
            if (elem == "More Categories") {
                $(".ec-more-toggle-3 #ec-more-toggle-2").text("Less Categories");
                $(".ec-more-toggle-3").toggleClass('active');
                $("#ec-more-toggle-content-2").slideDown();
            } else {

                $(".ec-more-toggle-3  #ec-more-toggle-2").text("More Categories");
                $(".ec-more-toggle-3").removeClass('active');
                $("#ec-more-toggle-content-2").slideUp();
            }
        });
    });
