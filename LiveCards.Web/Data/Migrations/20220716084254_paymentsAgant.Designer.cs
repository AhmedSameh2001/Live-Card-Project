...
namespace LiveCards.Data.Migrations
{
    ...
    [Migration("20220716084254_paymentsAgant")]
    partial class paymentsAgant
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiveCards.Models.Card", b =>
                {
                    ...
                    b.Property<string>("CustomMapping")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("CustomerPercent")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("DefaultPriceAmount")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("FaceValueAmount")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FaceValueCurrency")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LiveCards.Models.Payments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LiveCards.Models.PrepaidForgeAPI.ProductAPIDetails1", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Temp_ProductAPIDetails");
                });
            ...
            modelBuilder.Entity("LiveCards.Models.PrepaidForgeAPI.ProductAPIStock", b =>
                {
                    ...
                    b.ToTable("ProductAPIStocks");
                });

            modelBuilder.Entity("LiveCards.Models.PrepaidForgeAPI.ProductAPIStock1", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Temp_PrepaidForgeStocks");
                });
            ...
            modelBuilder.Entity("LiveCards.Web.Models.Payments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LiveCards.Models.Payments", b =>
                {
                    b.HasOne("LiveCards.Models.Agent", null)
                        .WithMany("Payments")
                        .HasForeignKey("AgentId");
