...
namespace LiveCards.Data.Migrations
{
    ...
    [Migration("20220530104008_intial_DB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiveCards.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LiveCards.Models.Dealer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CreditChanges")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("Distributor1Id")
                        .HasColumnType("int");

                    b.Property<int?>("HeadDelear")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MaxNegativeCredit")
                        .HasColumnType("int");

                    b.Property<string>("Name")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("NegativeCredit")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LiveCards.Models.Package", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("CanCutDuringOffer")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal?>("PriceDealer")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("PriceOfferCustomer")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("PriceOfferDealer")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("PriceOfferShop")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("PriceShop")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("LiveCards.Models.PackageDealer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("PriceCostOffer")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("PriceCustomer")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("PriceCustomerOffer")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("PriceDealer")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("PriceDealerOffer")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("PackageDealers");
                });

            modelBuilder.Entity("LiveCards.Models.PackageOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LiveCards.Models.PackagesCompaniesDealer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PackagesCompaniesId")
                        .HasColumnType("int");

                    b.Property<int?>("PackagesCompanyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PackagesCompanyId");

                    b.ToTable("PackagesCompaniesDealers");
                });

            modelBuilder.Entity("LiveCards.Models.PackagesCompany", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LiveCards.Models.Adverty", b =>
                {
                    b.HasOne("LiveCards.Models.Company", "Company")
                        .WithMany("Advertys")
            ...
            modelBuilder.Entity("LiveCards.Models.Dealer", b =>
                {
                    ...
                    b.HasOne("LiveCards.Models.Dealer", "Distributor1")
                        .WithMany("Distributors1")
                        .HasForeignKey("Distributor1Id");

                    b.Navigation("ApplicationUser");

                    b.Navigation("Distributor1");
                });
            ...
            modelBuilder.Entity("LiveCards.Models.DealerBill", b =>
                {
                    ...
                    b.HasOne("LiveCards.Models.Dealer", "Distributor")
                        .WithMany("DealerBills")
            ...
            modelBuilder.Entity("LiveCards.Models.Package", b =>
                {
                    ...
                    b.HasOne("LiveCards.Models.PackageOffer", "PackageOffer")
                        .WithMany("Packages")
            ...
            modelBuilder.Entity("LiveCards.Models.PackageDealer", b =>
                {
                    b.HasOne("LiveCards.Models.Dealer", "Distributor")
                        .WithMany("PackageDealers")
                        .HasForeignKey("DealerId");

                    b.HasOne("LiveCards.Models.Package", "Package")
                        .WithMany("PackageDealers")
            ...
            modelBuilder.Entity("LiveCards.Models.PackagesCompaniesDealer", b =>
                {
                    b.HasOne("LiveCards.Models.Dealer", "Distributor")
                        .WithMany("PackagesCompaniesDealers")
                        .HasForeignKey("DealerId");

                    b.HasOne("LiveCards.Models.PackagesCompany", "PackagesCompany")
                        .WithMany("PackagesCompaniesDealers")
                        .HasForeignKey("PackagesCompanyId");

                    b.Navigation("Distributor");

                    b.Navigation("PackagesCompany");
                });

            modelBuilder.Entity("LiveCards.Models.PackagesCompany", b =>
                {
                    b.HasOne("LiveCards.Models.Company", "Company")
                        .WithMany("PackagesCompanies")
                        .HasForeignKey("CompanyId");
            ...
            modelBuilder.Entity("LiveCards.Models.Company", b =>
                {
                    ...
                    b.Navigation("Advertys");

                    b.Navigation("Numbers");

                    b.Navigation("Packages");

                    b.Navigation("PackagesCompanies");
                });
            ...
            modelBuilder.Entity("LiveCards.Models.Dealer", b =>
                {
                    ...
                    b.Navigation("Distributors1");

                    b.Navigation("Numbers");

                    b.Navigation("PackageDealers");

                    b.Navigation("PackagesCompaniesDealers");
